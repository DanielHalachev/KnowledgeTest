...
INSERT INTO `answers` (id, questionId, uploaderId, label, isCorrect)
VALUES (21, 6, 1, "Манипулиране на URL адресите на уеб приложението", 1);

INSERT INTO `answers` (id, questionId, uploaderId, label, isCorrect)
VALUES (22, 6, 1, "Управление на HTTP заявки и отговори", 0);

INSERT INTO `answers` (id, questionId, uploaderId, label, isCorrect)
VALUES (23, 6, 1, "Интеграция със социални мрежи", 0);

INSERT INTO `answers` (id, questionId, uploaderId, label, isCorrect)
VALUES (24, 6, 1, "Валидация на форми в реално време", 0);
